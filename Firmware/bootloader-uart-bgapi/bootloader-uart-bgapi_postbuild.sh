...
if [ -z "${PATH_SCMD}" ]; then
  COMMANDER="/home/mortzula/SimplicityStudio_v4/developer/adapter_packs/commander/commander"
...
echo " "
"${COMMANDER}" convert "/home/mortzula/SimplicityStudio_v4/developer/sdks/gecko_sdk_suite/v1.1/platform/bootloader/build/first_stage/gcc/first_stage_btl_efr32xg13.s37" "${FILENAME}.s37" -o "${FILENAME}-combined.s37"
